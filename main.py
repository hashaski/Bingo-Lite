...
def mostra_footer():
    ...
    while (resposta != "") and (resposta < "1" or resposta > "4"):
        resposta = input(f"\n# REPOSTA INVÁLIDA! SELECIONE OUTRA CARTELA ({cartelas_livres[0]+1}, {cartelas_livres[1]+1} ou {cartelas_livres[2]+1}) ou PRESSIONE ENTER PARA SORTEAR: ")
    if resposta == "":
        sorteia_numero()
    else:
